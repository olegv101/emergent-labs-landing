...
const AnimatedPlane: FC<AnimatedPlaneProps> = ({
  position,
  rotation,
  lightness,
}) => {
...
const Scene: FC = () => {
  ...
  const planes = [
    ...
    },
    {
      ...
      rotation: [0.2, -0.1, 0.15] as [number, number, number],
      lightness: 0.5,
    },
    {
      position: [-1.5, 1.5, -3] as [number, number, number],
      rotation: [-0.15, -0.2, 0.1] as [number, number, number],
      lightness: 0.65,
    },
    {
      position: [1.5, -0.5, -3.5] as [number, number, number],
      rotation: [0.1, 0.15, -0.1] as [number, number, number],
      lightness: 0.8,
    },
  ];
